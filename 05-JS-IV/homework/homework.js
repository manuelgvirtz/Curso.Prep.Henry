...
function sumarLikesDeUsuario(usuario) {
  ...
  // Devuelve la suma
  // Tu código:
  // var valor = usuario[posts[post.likes]].reduce(function(previousValue, currentValue){
  //   return previousValue.usuario[posts[post.likes]] + currentValue.usuario.posts[[post.likes]]  
  // });
  // return valor;
  sumaDeLikes = 0
  const posteos = usuario.posts
  posteos.forEach(function(post){
    sumaDeLikes = sumaDeLikes + post.likes;
  });
  return sumaDeLikes;
}
